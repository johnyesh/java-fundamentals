package com.fundamentals.lessons;
    ...
    /*
    * The content of the class goes over Lesson7 content
    * Java Operators
    * */
    public class Lesson7 {
        ...
        public void exampleOr() {
            // The number is in binary is 1111
         ...
         * If the bits vary compared, a 1 takes its place.
         * */
         ...
         * primitive type and convert it to to the binary bits of the number
        ...
        public void exampleRightShift() {
            // The number 30 in binary is 0001 1110
            // Shifting the value by 2 results in 0111 0r 7
            int result = 30 >> 2;
            System.out.println(result);
        }
